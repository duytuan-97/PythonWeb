document.addEventListener("DOMContentLoaded", function () {
    console.log("⏳ Đang khởi tạo bảng object permission cho group...");

    const tableWrappers = document.querySelectorAll('.group-object-perm-table table');
    ...
    tableWrappers.forEach(function (table) {
        ...
        if (typeof jQuery === 'undefined') {
            ...
            console.log("✅ DataTables cho group đã sẵn sàng.");
            $(table).DataTable({
                pageLength: 5,
                lengthChange: false,
                searching: true,
