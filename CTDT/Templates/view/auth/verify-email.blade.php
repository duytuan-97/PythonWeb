				...
				<div class="d-flex flex-column flex-center text-center p-10">
					...
					<div class="card card-flush w-lg-650px py-5">
						<div class="card-body py-15 py-lg-20">
							...
							<!--begin::Action-->
							<div class="fs-6 mb-8">
								<span class="fw-semibold text-gray-500">Did’t receive an email?
                                <form method="POST" action="{{ route('verification.send') }}">
                                    @csrf
                                    <a type="submit" class="link-primary fw-bold">
                                        Try Again
                                    </a>
                                </form>
                            </span>
...
<div class="card card-flush w-lg-650px py-5">
        ...
        <div class="fs-6 mb-8">
            ...
            <form method="POST" action="{{ route('verification.send') }}">
                @csrf
                    <input type="submit" class="btn btn-primary btn-sm fw-bold" value="Try Again">
            </form>
        </span>
        </div>
        <!--end::Action-->
